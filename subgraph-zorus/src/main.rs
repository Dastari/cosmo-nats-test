...
impl Mutation {
    #[graphql(name = "ZorusIncrementValue")]
...
impl Subscriptions {
    #[graphql(name = "ZorusOnValueChange")]
...
async fn main() -> anyhow::Result<()> {
    ...
    let subject = "gema.zorus.value.updated".to_string();
    let owner_id = ID::from("zorus");
    ...
    let app = Router::new()
        .route("/", get(|| graphiql("Zorus".to_string())))
