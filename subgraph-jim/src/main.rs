...
impl Mutation {
    #[graphql(name = "JimIncrementValue")]
...
async fn main() -> anyhow::Result<()> {
    ...
    let subject = "gema.jim.value.updated".to_string();
    let owner_id = ID::from("jim");
    ...
    let app = Router::new()
        .route("/", get(|| graphiql("Jim".to_string())))
